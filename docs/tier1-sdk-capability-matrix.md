...
| Documentation coverage | Partial | README has broad examples; dedicated guides now cover auth/OAuth, elicitation, sampling, Streamable HTTP, and tools. | Add dedicated guides for resources/templates/subscriptions, prompts/completion, roots, logging, and pagination. |
...
2. Remaining feature guides:
   add focused guides for resources/templates/subscriptions,
   prompts/completion, roots, logging, and pagination.

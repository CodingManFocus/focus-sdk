...
1. Auth/OAuth parity:
   add high-level client credentials provider support, dynamic registration
   guidance, and server-side resource-server middleware/examples.

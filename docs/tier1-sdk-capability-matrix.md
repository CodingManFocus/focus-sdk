...
| Applicable conformance | Ready, keep fresh | `docs/conformance-status.md` records a clean full run at `6c4d26f` for server, client core, and client auth. | Refresh after protocol, transport, auth, or runner changes. |

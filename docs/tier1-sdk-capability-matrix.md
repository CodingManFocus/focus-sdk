...
1. Auth/OAuth parity:
   add document hosting/token persistence guidance, non-JVM JWT assertion
   signing guidance, and full JWT/JWKS validation examples.

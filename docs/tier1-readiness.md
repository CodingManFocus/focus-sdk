...
- Feature docs are not yet comprehensive for resources/templates/subscriptions,
  prompts/completion, roots, logging, and pagination. Dedicated guides now
  cover OAuth, Streamable HTTP, elicitation, sampling, and tools.
...
- Add feature examples for resources/templates, subscriptions,
  prompts/completion, roots, logging, pagination, and security-sensitive host
  validation.

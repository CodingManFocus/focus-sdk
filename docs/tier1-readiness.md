...
- Feature docs are not yet comprehensive for logging and pagination. Dedicated
  guides now cover OAuth, Streamable HTTP, elicitation, prompts/completion,
...
- Add feature examples for logging, pagination, and security-sensitive host
  validation.

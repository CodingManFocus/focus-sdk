...
- Feature docs are not yet comprehensive for prompts/completion, roots,
  logging, and pagination. Dedicated guides now cover OAuth, Streamable HTTP,
  elicitation, resources/templates/subscriptions, sampling, and tools.
...
- Add feature examples for prompts/completion, roots, logging, pagination, and

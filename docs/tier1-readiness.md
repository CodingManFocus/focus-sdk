...
- Feature docs are not yet comprehensive for roots, logging, and pagination.
  Dedicated guides now cover OAuth, Streamable HTTP, elicitation,
  prompts/completion, resources/templates/subscriptions, sampling, and tools.
...
- Add feature examples for roots, logging, pagination, and security-sensitive
  host validation.
